...
use App\Http\Requests\Operator\Form\FormMenuRequest;
use App\Http\Requests\Operator\Search\SearchMenuRequest;
use App\Models\Menu;
use App\UseCases\Operator\Menu\CreateMenuUseCase;
use App\UseCases\Operator\Menu\DeleteMenuUseCase;
use App\UseCases\Operator\Menu\ExportMenuUseCase;
use App\UseCases\Operator\Menu\FetchMenuListUseCase;
use App\UseCases\Operator\Menu\PrepareMenuCreateFormUseCase;
use App\UseCases\Operator\Menu\PrepareMenuEditFormUseCase;
use App\UseCases\Operator\Menu\UpdateMenuUseCase;
use DomainException;
...
class MenuController extends Controller
{
    ...
    public function store(FormMenuRequest $request, CreateMenuUseCase $useCase): RedirectResponse
    {
        ...
        return redirect()->route('admin.menus.index')->with('success', '登録に成功しました。');
    }
