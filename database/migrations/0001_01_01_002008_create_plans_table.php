...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('plans', function (Blueprint $table) {
            ...
            $table->unsignedInteger('regular_price')->comment('通常価格');
            $table->unsignedInteger('selling_price')->comment('案内価格');
            $table->enum('condition_type', PlanConditionTypeEnum::values())->nullable()->comment('適用条件種別');
            $table->enum('active_flag', ActiveFlagTypeEnum::values())->default('active')->comment('公開状態');
